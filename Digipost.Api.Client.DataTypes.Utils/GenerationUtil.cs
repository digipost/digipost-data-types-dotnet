    ...
    public class GenerationUtil
    {
        static void Main(string[] args)
        {
            ...
            Generator generator = new Generator
            {
                ...
                OutputWriter = new SingleFileOutputWriter($"{projectRootRelativePath}/Digipost.Api.Client.DataTypes.Core/Internal") { OutputFile = "DataTypes.cs"},
                GenerateComplexTypesForCollections = true,
                NamespaceProvider = new Dictionary<NamespaceKey, string>
                {
                    { new NamespaceKey("http://api.digipost.no/schema/datatypes"), "Digipost.Api.Client.DataTypes.Core.Internal" }
